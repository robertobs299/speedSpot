    ...
    def show_add_vehicle_dialog(self):
        self.dialog = MDDialog(
            ...
            buttons=[
                ...
                MDRaisedButton(text="AÑADIR", on_release=self.add_vehicle_to_db)
            ]
        )
        self.dialog.open()
